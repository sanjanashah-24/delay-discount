...
expName = 'adaptive_staircase_1-9-23'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Sanjana\\Desktop\\PSYCHOLOGY LAB\\adaptive_staircase_1-9-23_lastrun.py',
